package inviqa.com.workshop.api
...
/**
  * The Workshop service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the WorkshopService.
  */
trait WorkshopService extends Service {
  ...
  override final def descriptor = {
    ...
    named("workshop")
      ...
      .withTopics(
        topic(WorkshopService.TOPIC_NAME, greetingsTopic _)
